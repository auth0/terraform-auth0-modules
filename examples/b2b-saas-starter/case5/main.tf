# Case 5: Enterprise SSO - SAML
#
# Provisions one enterprise organization with a SAML 2.0 identity provider.
# Users from globex.com are automatically routed to the Globex IdP at login.
